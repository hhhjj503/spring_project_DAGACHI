...
<form id="adminUpdate" action="adminUpdate" method="post" onsubmit="return chk()">
	<table align="center" style="width: 500px;">
		...
		<b>사용자 ID : </b> <input type="text" id="admin_Id"name="admin_Id" value="${adminUpdate.admin_Id}" readonly="readonly"
		style="background-color: #D0CECD;height: 20px;background: none;border: none;outline: none;font-size:medium;" />
		
		<!-- 관리자 번호 -->
		<input type="text" id="admin_Num" name="admin_Num"value="${adminUpdate.admin_Num}"
		...
		value="${adminUpdate.admin_Name}" readonly="readonly"> <br/><br/>
		<b>암호</b> <input type="password" id="admin_Password" name="admin_Password" style="height: 20px;" value="${adminUpdate.admin_Password}"><br/><br/>
		<b>E-mail</b> <input type="text" id="admin_Email" name="admin_Email" style="height: 20px;" value="${adminUpdate.admin_Email}"> <br/><br/>
		<b>연락처</b> <input type="text" id="admin_PhoneNumber" name="admin_PhoneNumber" style="height: 20px;" value="${adminUpdate.admin_PhoneNumber}"><br/><br/>
		<b>사용 여부</b>
		...
		<b>사용자 그룹</b> <input type="text" style="height: 20px;" value="${adminUpdate.dept}" name="dept" >
		<br/><br/>	
			<p align="center">
		...
		<input type="button" style="background-color: #665F79;margin-left: 4px;
			color: white;border-radius: 5px 5px 5px 5px;padding-left: 10px;padding-right: 10px;"
			value="삭제" name="delete" onclick="del()">
