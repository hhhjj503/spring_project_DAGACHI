...
<form id="noticeUpdate" action="noticeUpdate" method="post" onsubmit="return chk()" >
	...
	style="width: 400px;background:none;border:none;outline: none;height: 20px;font-size: medium;"
	...
	<br/></p>
 	...
 	<c:choose>
 	<c:when test="${search == 0 && log_In_Admin.admin_Num == choose.admin_Num}">
	...
	value="목록" onclick="location.href='searchNoticeBack?searchstr=${choose.admin_Num}&&search=${search}'">
 	</div>
 		<div style="position: absolute;margin-top: 37%;margin-left: 67.3%;z-index: 35;"> <!-- 수정/삭제 전송 div -->
 <form action="searchNoticeInfo" method="get">
 ...
 <input type="submit" style="background-color: #665F79;float: right;margin-left: 4px;
	...
	value="수정/삭제" >
 	...
 	<c:when test="${search == 1 && log_In_Admin.admin_Num == choose.admin_Num}" >
 	<div style="padding-right: 4px; padding-left: 4px;margin-top: 704px;margin-left: 1223px;position: absolute;z-index: 50" align="right"> 
 	<input type="button" style="background-color: #665F79;float: right;margin-left: 4px;
	color: white;border-radius: 5px 5px 5px 5px;padding-left: 10px;padding-right: 10px;"
	value="목록" onclick="location.href='searchNoticeBack?searchstr=${searchstr}&&search=${search}'">
 	</div>
	<div style="position: absolute;margin-top: 37%;margin-left: 67.3%;z-index: 35;"> <!-- 수정/삭제 전송 div -->
 <form action="searchNoticeInfo" method="get">
 <input type="hidden" id="searchstr" name="searchstr" value="${searchstr}" />
