...
<li>관리자 정보
	<ul class="sub">
		<li><a href="a_noticeList_admin">공지사항</a></li>
...
<form id="noticeWrite" action="noticeWrite" method="post" onsubmit="return chk()">
	...
	<b> 작성자 : </b><input type="text" id="admin_Num" name="admin_Num" style="background-color: white;outline: none;border: none;" value="${log_In_Supervisor.admin_Num}"
